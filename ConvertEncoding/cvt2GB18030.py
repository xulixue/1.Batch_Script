...
def convert_encoding_to_utf_8(filename):
    ...
    if source_encoding != 'gb18030':
        content = content.decode(source_encoding, 'ignore') #.encode(source_encoding)
        codecs.open(filename, 'w', encoding='gb18030').write(content)
    success_cnt+=1
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        sys.exit(-1)
    print "Set Convert Type:",convertfiletypes
    print "Notice to change!"
